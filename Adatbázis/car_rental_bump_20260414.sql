...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Ápr 14. 21:13
...
(2, 1, 2, '2026-04-14', '2026-04-15', 95000, 'cancelled'),
(3, 1, 1, '2026-04-30', '2026-05-07', 595000, 'cancelled'),
(4, 2, 4, '2026-04-14', '2026-04-17', 225000, 'confirmed');
...
(7, 'App\\Models\\User', 4, 'api-token', '219b12b55b001fae3f88ba9a5bc8cf52c7f036b274c38bbe82e7b685db3baccd', '[\"*\"]', '2026-04-14 16:54:19', NULL, '2026-04-14 16:15:46', '2026-04-14 16:54:19');
...
(2, 'test2', 'test2@mail.com', '06203214321', '$2y$12$9AunFPsWeZF3VeifXOVj/uBeYHxfldild/pJJFHfS0CKDRer2t3lK', 0, NULL),
(3, 'Admin', 'admin@admin.com', NULL, '$2y$12$UtLQBb.L9Vxk.uaqV/hGQODhgJAPwx9JaYHuebXzPRx1i6wI4j27a', 1, NULL),
(4, 'teszt3', 'test3@mail.com', NULL, '$2y$12$Aq1.Ljp/t4cZWwxzePw.zuU4tICfIIpgtgZhu9cKqFsScEz3Fo0vW', 0, NULL);
